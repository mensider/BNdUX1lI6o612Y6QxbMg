...
def swarm_algorithm(grid,b1,b2,b3): #,b4):
    ...
    if (bot1_cross1 is True):   # if bot 1 is going into cross 1
        ...
        if(bot3_cross1 is True):
            ...
            print("B3 : ", bot3_path)
        #if (bot4_cross1 is True):
        #    print("1 and 4 : Type 0")
        #    bot4_path.insert(0, bot4_path[0])   #hold the bot
    ...
    #if (bot3_cross1 is True): # if bot 3 is going into cross 1
    #    if (bot4_cross1 is True):
    #        print("3 and 4 : Type 0")
    #        bot4_path.insert(0, bot4_path[0])  # hold the bot
    #if (bot3_cross2 is True):   # if bot 3 is going to cross 2
    #    if (bot4_cross2 is True):
    #        print("3 and 4 : Type 0")
    #        bot4_path.insert(0, bot4_path[0])  # hold the bot
    ...
    #    G.remove_node(bot1_path[1])  # By removing the busy node from the graph
    #    try:
    #        bot4_path = nx.bidirectional_shortest_path(G, b4_curr, b4_dst)
    #    except:     #if there is not a path possible..
    #        print("Error 102")
    #        bot4_path.insert(0, bot4_path[0])  # hold the bot
